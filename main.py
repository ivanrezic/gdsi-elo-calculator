...
with main_container:
    ...
    elo1 = p1_cols[1].number_input("ELO 1", min_value=0, value=1432, step=1, key="elo1", label_visibility="collapsed")
    ...
    elo2 = p2_cols[1].number_input("ELO 2", min_value=0, value=1329, step=1, key="elo2", label_visibility="collapsed")
